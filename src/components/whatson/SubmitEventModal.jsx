        ...
        {submitted ? (
          ...
          <form onSubmit={handleSubmit} className="p-4 sm:p-6 space-y-4">
            ...
            <label className="block">
              <span className="text-sm font-semibold text-dark">Event Name *</span>
              <input
                type="text"
                value={form.title}
                ...
                placeholder="e.g. Easter Family Fun Day"
              />
            </label>
            ...
            <label className="block">
              ...
              <input
                ...
                className="mt-1 w-full px-3 py-2.5 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-primary/50"
                placeholder="e.g. Greenwich Park"
              />
            </label>
            ...
            <label className="block">
              ...
              <textarea
                ...
                rows={3}
                className="mt-1 w-full px-3 py-2.5 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-primary/50 resize-none"
            ...
            <label className="block">
              <span className="text-sm font-semibold text-dark">Event Link</span>
              <input
                type="url"
                value={form.url}
